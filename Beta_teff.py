...
df_trap = pd.read_csv('Data/Smooth_output_PS_new/betateffoverall/PS_Gaia_2306-0502 (M7.5) SED_spexified.txt', sep=" ",
...
#                            names=["w", "f", "err"])
df_0953 = pd.read_csv('Data/Smooth_output_PS_new/betateffoverall/PS_new_0953-1014 (L0gamma) SED_spexified.txt', sep=" ", comment='#',
                      header=None, names=["w", "f", "err"])
df_0953_phot = pd.read_csv('Data/beta_comp/betateffoverall/PS_new_0953-1014 (L0gamma) phot.txt', sep=" ", comment='#', header=None,
                           names=["w", "f", "err"])
...
# ------ Labeling Objects --------
ax1.annotate('TRAPPIST-1 (M7.5) $T_\mathrm{eff}: 2629 \pm 34$ K', xy=(2.5, 2*10**(-14)), color='k', fontsize=15)
# ax1.annotate('J0253+3206 (M7$\\beta$), $T_\mathrm{eff}: 2581 \pm 265$ K', xy=(2, 2*10**(-14)), color='#D01810',
# fontsize=15)
ax1.annotate('J0953-1014 (M9 $\\beta$) $T_\mathrm{eff}: 2440 \pm 250$ K', xy=(2.5, 1.4*10**(-14)), color='#D01810',
             fontsize=15)
