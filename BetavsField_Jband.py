...
# Add labels
ax1.annotate('J0253+3206 (M7 $\\beta$)', xy=(1.26, 1.2), color='#D01810', fontsize=15)
ax1.annotate('J2235-5906 (M8.5 $\\beta$)', xy=(1.26, 2.2), color='#8E01E8', fontsize=15)
ax1.annotate('J2154-7459 (M9.5 $\\beta$)', xy=(1.26, 3.5), color='#E806B7', fontsize=15)
ax1.annotate('J0320+1854 (M8)', xy=(1.26, 4.2), color='#1EE801', fontsize=15)
ax1.annotate('vb8 (M7)', xy=(1.26, 5.2), color='#04A57F', fontsize=15)
ax1.annotate('vb10 (M8)', xy=(1.26, 6.2), color='#275202', fontsize=15)

plt.savefig('Figures/Stack_Jband.pdf', dpi=150)
