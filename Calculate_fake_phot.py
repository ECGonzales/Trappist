...
data = list()
data.append(['source_id', 'band', 'magnitude', 'magnitude_unc', 'publication_shortname'])
# vb8
data.append([1371,'PS_g',17.4262, 0.0042,'Cham16'])
data.append([1371,'PS_r',16.0220,	0.0071,'Cham16'])
...
data.append([300,'PS_r',16.5893,0.0030,'Cham16'])
...
#0320
data.append([320,'PS_g',19.7975,0.0292,'Cham16'])
data.append([320,'PS_r',18.2044,0.0100,'Cham16'])
data.append([320,'PS_i',15.6026,0.0073,'Cham16'])
data.append([320,'PS_z',14.2388,0.0040,'Cham16'])
data.append([320,'PS_y',13.4329,0.0056,'Cham16'])
#LHS 3003
...
data.append([82,'PS_g',	19.0248,	0.0121,'Cham16'])
data.append([82,'PS_r',17.1756,	0.0094,'Cham16'])
...
data.append([355,'PS_g',19.7983,	0.0418,'Cham16'])
data.append([355,'PS_r',17.8464,	0.0084,'Cham16'])
data.append([355,'PS_i',15.5047,	0.0014,'Cham16'])
data.append([355,'PS_z',14.0634,	0.0047,'Cham16'])
data.append([355,'PS_y',13.1045,	0.0018,'Cham16'])
#SSSPM J1013-1356
data.append([1333,'PS_g',20.9931, 0.0730,'Cham16'])
data.append([1333,'PS_r',19.2511,0.0095,'Cham16'])
data.append([1333,'PS_i',17.1840,0.0005,'Cham16'])
data.append([1333,'PS_z',16.2469,0.0018,'Cham16'])
data.append([1333,'PS_y',15.9044,0.0027,'Cham16'])
# GJ660.1b
data.append([1476,'PS_y',14.40,0.018,'Best18'])
#1256
data.append([1357,'PS_r',21.7783,0.1857,'Cham16'])
data.append([1357,'PS_i',19.4728,0.0448,'Cham16'])
data.append([1357,'PS_z',18.0028,0.0264,'Cham16'])
data.append([1357,'PS_y',17.5395,0.0120,'Cham16'])
#1444
...
# Non 1247-38
#0608
data.append([413,'PS_r',20.9394,0.0241,'Cham16'])
data.append([413,'PS_i',18.1406,0.0037,'Cham16'])
data.append([413,'PS_z',16.5489,0.0055,'Cham16'])
data.append([413,'PS_y',15.5418,0.0067,'Cham16'])
# none 2000-75
#none 1207-39
#0443+0002 -- ADDED
# 0518
data.append([91,'PS_r',21.8871,	0.1550,'Cham16'])
data.append([91,'PS_i',19.9933,	0.0232,'Cham16'])
data.append([91,'PS_z',18.4875,	0.0119,'Cham16'])
data.append([91,'PS_y',17.4984,	0.0088,'Cham16'])
#None 2235-59
#0714
data.append([849,'PS_g',20.1524,	0.0257,'Cham16'])
...
#0953
data.append([415,'PS_r',20.4710,	0.0282,'Cham16'])
...
#2352
data.append([146,'PS_g',20.5741,	0.0248,'Cham16'])
...
#2341
data.append([669,'PS_g',21.1287,	0.0323,'Cham16'])
...
#None ---LHS 132
#0532
data.append([1304,'PS_z',18.0747,	0.0096,'Cham16'])
data.append([1304,'PS_y',16.9173,	0.0260,'Cham16'])
# LHS 377
data.append([1452,'PS_g',18.9919, 0.0124,'Cham16'])
...
#1610
data.append([1591,'PS_g',20.1155,	0.0963,'Cham16'])
...
#2036
data.append([1490,'PS_g',19.6098,	0.0150,'Cham16'])
