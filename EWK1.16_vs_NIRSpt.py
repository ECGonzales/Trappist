...
beta = plt.scatter(df_beta['SpT_used'], df_beta['KI_169'], color='#FF6B03', s=70, zorder=4)
...
fld_opt = plt.scatter(df_field_opt['SpT_used'], df_field_opt['KI_169'], color='#ABBDC4', s=70, zorder=4)
...
# FIRE
trap_f = plt.scatter(df_field2['SpT_used'][26], df_field2['KI_169'][26], color='k', s=400, zorder=2, marker="*")
...
#  ----- Plot comparisons -----
# gamma_m = plt.scatter(df_comp_gamma['SpT_num'], df_comp_gamma['K1.1692'], color='#9B0132', s=30, zorder=4, marker="s")
# ax1.errorbar(df_comp_gamma['SpT_num'], df_comp_gamma['K1.1692'], yerr=df_comp_gamma['e_K1.1692'], c='#9B0132', fmt='o', zorder=3)
#
# beta_m = plt.scatter(df_comp_beta['SpT_num'], df_comp_beta['K1.1692'], color='#FF6B03', s=30, zorder=4, marker="s")
# ax1.errorbar(df_comp_beta['SpT_num'], df_comp_beta['K1.1692'], yerr=df_comp_beta['e_K1.1692'], c='#FF6B03', fmt='o', zorder=3)
#
# fld_m = plt.scatter(df_comp_field['SpT_num'], df_comp_field['K1.1692'], color='#7C7D70', s=30, zorder=4, marker="s")
# ax1.errorbar(df_comp_field['SpT_used'], df_comp_field['K1.1692'], yerr=df_comp_field['e_K1.1692'], c='#7C7D70', fmt='o', zorder=3)
