...
# FIRE
trap_f = plt.scatter(df_field2['SpT_used'][24], df_field2['KI_169'][24], color='k', s=900, zorder=2, marker="*")
ax1.errorbar(df_field2['SpT_used'][24], df_field2['KI_169'][24], yerr=df_field2['E_KI_169'][24], c='k', zorder=2, fmt='o')
# SXD
trap_s = plt.scatter(df_field2['SpT_used'][25], df_field2['KI_169'][25], color='k', s=500, zorder=2, marker="o")
