...
df_comp = pd.read_csv('Data/Martin_EW_tab.txt', sep='\t', comment='#', header=0)  # Doesn't have NA lines
...
beta = plt.scatter(df_beta['SpT_used'], df_beta['NAI'], color='#FF6B03', s=70, zorder=4)
ax1.errorbar(df_beta['SpT_used'], df_beta['NAI'], yerr=df_beta['E_NAI'], c='#FF6B03', fmt='o', zorder=3)
...
fld_opt = plt.scatter(df_field_opt['SpT_used'], df_field_opt['NAI'], color='#ABBDC4', s=70, zorder=4)
ax1.errorbar(df_field_opt['SpT_used'], df_field_opt['NAI'], yerr=df_field_opt['E_NAI'], c='#ABBDC4', fmt='o', zorder=3)
