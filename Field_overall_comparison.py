...
ax1.annotate('Trappist-1 (M7.5) $T_\mathrm{eff}: 2582 \pm 34$ K', xy=(2.7, 10**(-14)), color='k', fontsize=15)
ax1.annotate('$L_\mathrm{bol}: -3.254 \pm 0.002$', xy=(8, 5.2*10**(-15)), color='k', fontsize=15)
