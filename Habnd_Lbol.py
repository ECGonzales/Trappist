...
ax1.annotate('J1207-3900 (L1 $\gamma$) $L_\mathrm{bol}: -3.337 \pm 0.053$', xy=(1.421, 1.6), color='#1036CF', fontsize=14)
# vb10
...
ax1.annotate('vB 10 (M8) $L_\mathrm{bol}: -3.298 \pm 0.018$', xy=(1.421, 2.4), color='#275202', fontsize=14)
# 0518
...
ax1.annotate('J0518-2756 (L1 $\gamma$) $L_\mathrm{bol}: -3.273 \pm 0.041$', xy=(1.421, 3.5), color='#5518C2', fontsize=14)
# 320
...
ax1.annotate('J0320+1854 (M8) $L_\mathrm{bol}: -3.226 \pm 0.007$', xy=(1.421, 4.3), color='#1EE801', fontsize=14)
# Trappist
ax1.plot(trap_bin[0], trap_bin[1] + 4, c='k')
# ax1.plot(df_trap['w'], norm_df_trap + 3.3, c='k')
ax1.annotate('TRAPPIST-1 (M7.5) $L_\mathrm{bol}: -3.216 \pm 0.016$', xy=(1.421, 5.3), color='k', fontsize=14)
# 0443
...
ax1.annotate('J0443+0002 (L0 $\gamma$) $L_\mathrm{bol}: -3.194\pm 0.009$', xy=(1.421, 6.5), color='#E71BF8', fontsize=14)
# vb8
...
ax1.annotate('vB 8 (M7) $L_\mathrm{bol}: -3.192 \pm 0.006$', xy=(1.421, 7.3), color='#04A57F', fontsize=14)
