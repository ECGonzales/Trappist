...
ax1.annotate('vB 10 (M8) $L_\mathrm{bol}: -3.309 \pm 0.017$', xy=(1.421, 2.4), color='#275202', fontsize=14)
# 0518
...
ax1.annotate('J0518-2756 (L1 $\gamma$) $L_\mathrm{bol}: -3.273 \pm 0.04$', xy=(1.421, 3.5), color='#5518C2', fontsize=14)
# 320
...
ax1.annotate('TRAPPIST-1 (M7.5) $L_\mathrm{bol}: -3.210 \pm 0.012$', xy=(1.421, 5.3), color='k', fontsize=14)
# 0443
...
ax1.annotate('J0443+0002 (L0 $\gamma$) $L_\mathrm{bol}: -3.199\pm 0.006$', xy=(1.421, 6.5), color='#E71BF8', fontsize=14)
# vb8
...
ax1.annotate('vB 8 (M7) $L_\mathrm{bol}: -3.193 \pm 0.006$', xy=(1.421, 7.3), color='#04A57F', fontsize=14)
