...
ax1.annotate('vb10 (M8) $L_\mathrm{bol}: -3.298 \pm 0.002$', xy=(1.421, 3.8), color='#275202', fontsize=14)
# Trappist
...
ax1.annotate('vb8 (M7) $L_\mathrm{bol}: -3.192 \pm 0.007$', xy=(1.421, 7.5), color='#04A57F', fontsize=14)
