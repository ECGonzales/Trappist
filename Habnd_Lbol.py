...
ax1.annotate('J1207-3900 (L1 VL-G) $L_\mathrm{bol}: -3.336 \pm 0.053$', xy=(1.421, 1.6), color='#1036CF', fontsize=14)
# 0518
...
ax1.annotate('J0518-2756 (L1 VL-G) $L_\mathrm{bol}: -3.328 \pm 0.041$', xy=(1.421, 3), color='#5518C2', fontsize=14)
# vb10
...
ax1.annotate('J0443+0002 (L0 VL-G) $L_\mathrm{bol}: -3.194\pm 0.003$', xy=(1.421, 6.6), color='#E71BF8', fontsize=14)
# vb8
