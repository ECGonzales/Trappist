...
FeH['y'] = [1.52, 1.52]
plt.plot(FeH['x'], FeH['y'], color='k')
ax1.annotate('FeH', xy=(1.6, 1.53), color='k', fontsize=15)
FeHd = pd.DataFrame()
FeHd['x'] = [1.581, 1.581]
FeHd['y'] = [1.37, 1.52]
plt.plot(FeHd['x'], FeHd['y'], color='k')
...
CH4['y'] = [1.6, 1.6]
plt.plot(CH4['x'], CH4['y'], color='k')
ax1.annotate('CH$_\mathrm{4}$', xy=(1.70, 1.62), color='k', fontsize=15)
CH4d = pd.DataFrame()
CH4d['x'] = [1.67, 1.67]
CH4d['y'] = [1.5, 1.6]
plt.plot(CH4d['x'], CH4d['y'], color='k')
...
plt.tight_layout()
plt.savefig('Figures/Hbandbestfit_stack.png', dpi=150)
