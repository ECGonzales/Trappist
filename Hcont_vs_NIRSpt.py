...
# Prism
trap_p = plt.scatter(df_field2['SpT_used'][23], df_field2['HCONT'][23], color='k', s=300, zorder=2, marker="s")
ax1.errorbar(df_field2['SpT_used'][23], df_field2['HCONT'][23], yerr=df_field2['E_HCONT'][23], c='k', zorder=2, fmt='o')
# FIRE
trap_f = plt.scatter(df_field2['SpT_used'][24], df_field2['HCONT'][24], color='k', s=900, zorder=2, marker="*")
ax1.errorbar(df_field2['SpT_used'][24], df_field2['HCONT'][24], yerr=df_field2['E_HCONT'][24], c='k', zorder=2, fmt='o')
# SXD
trap_s = plt.scatter(df_field2['SpT_used'][25], df_field2['HCONT'][25], color='k', s=300, zorder=2, marker="o")
