...
ax1.annotate('vB 10 (M8) $L_\mathrm{bol}: -3.298 \pm 0.018$', xy=(1.121, 2.3), color='#275202', fontsize=14)
# 0518
...
ax1.annotate('TRAPPIST-1 (M7.5) $L_\mathrm{bol}: -3.216 \pm 0.016$', xy=(1.121, 5.3), color='k', fontsize=14)
# 0443
...
ax1.annotate('J0443+0002 (L0 $\gamma$) $L_\mathrm{bol}: -3.194\pm 0.009$', xy=(1.121, 6.3), color='#E71BF8', fontsize=14)
# vb8
...
ax1.annotate('vB 8 (M7) $L_\mathrm{bol}: -3.192 \pm 0.006$', xy=(1.121, 7.5), color='#04A57F', fontsize=14)
