...
ax1.annotate('J1207-3900 (L1 VL-G) $L_\mathrm{bol}: -3.336 \pm 0.053$', xy=(1.121, 1.3), color='#1036CF', fontsize=14)
# 0518
...
ax1.annotate('J0518-2756 (L1 VL-G) $L_\mathrm{bol}: -3.328 \pm 0.041$', xy=(1.121, 2.3), color='#5518C2', fontsize=14)
# vb10
...
ax1.annotate('vb10 (M8) $L_\mathrm{bol}: -3.298 \pm 0.002$', xy=(1.121, 3.3), color='#275202', fontsize=14)
# Trappist
...
ax1.annotate('J0443+0002 (L0 VL-G) $L_\mathrm{bol}: -3.194\pm 0.003$', xy=(1.121, 6.3), color='#E71BF8', fontsize=14)
# vb8
...
ax1.annotate('vb8 (M7) $L_\mathrm{bol}: -3.192 \pm 0.002$', xy=(1.121, 7.5), color='#04A57F', fontsize=14)
