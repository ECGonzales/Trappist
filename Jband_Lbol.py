...
ax1.annotate('J1207-3900 (L1 $\gamma$) $L_\mathrm{bol}: -3.337 \pm 0.053$', xy=(1.121, 1.3), color='#1036CF', fontsize=14)
# vb10
ax1.plot(trap_bin[0], trap_bin[1] + 1.1, c='k')
# ax1.plot(df_trap['w'], norm_df_trap + 2.1, c='k')
ax1.plot(df_vb10['w'], norm_df_vb10 + 1.1, c='#275202', alpha=0.8)
ax1.annotate('vB 10 (M8) $L_\mathrm{bol}: -3.309 \pm 0.017$', xy=(1.121, 2.3), color='#275202', fontsize=14)
# 0518
ax1.plot(trap_bin[0], trap_bin[1] + 2.1, c='k')
ax1.plot(J0518_bin[0], J0518_bin[1] + 2.1, c='#5518C2', alpha=0.75)
# ax1.plot(df_trap['w'], norm_df_trap + 1, c='k')
# ax1.plot(df_0518['w'], norm_df_0518 + 1.1, c='#5518C2', alpha=0.75)
ax1.annotate('J0518-2756 (L1 $\gamma$) $L_\mathrm{bol}: -3.273 \pm 0.041$', xy=(1.121, 3.3), color='#5518C2', fontsize=14)
# 320
ax1.plot(trap_bin[0], trap_bin[1] + 3.1, c='k')
# ax1.plot(df_trap['w'], norm_df_trap + 4.1, c='k')
ax1.plot(df_0320['w'], norm_df_0320 + 3.1, c='#1EE801', alpha=0.75)
ax1.annotate('J0320+1854 (M8) $L_\mathrm{bol}: -3.226 \pm 0.007$', xy=(1.121, 4.3), color='#1EE801', fontsize=14)
# Trappist
ax1.plot(trap_bin[0], trap_bin[1] + 4.1, c='k')
# ax1.plot(df_trap['w'], norm_df_trap + 3.1, c='k')
ax1.annotate('TRAPPIST-1 (M7.5) $L_\mathrm{bol}: -3.210 \pm 0.012$', xy=(1.121, 5.3), color='k', fontsize=14)
# 0443
...
ax1.annotate('J0443+0002 (L0 $\gamma$) $L_\mathrm{bol}: -3.199\pm 0.006$', xy=(1.121, 6.3), color='#E71BF8', fontsize=14)
# vb8
...
ax1.annotate('vB 8 (M7) $L_\mathrm{bol}: -3.193 \pm 0.006$', xy=(1.121, 7.5), color='#04A57F', fontsize=14)
