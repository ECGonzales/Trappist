...
ax1.annotate('J0608-2753 (L0 $\gamma$) $T_\mathrm{eff}: 2471 \pm 255$ K', xy=(1.121, 1.2), color='#FF6B03', fontsize=15)
# vb10
...
ax1.annotate('vB 10 (M8) $T_\mathrm{eff}: 2541 \pm 45$ K', xy=(1.121, 2.2), color='#275202', fontsize=15)
# 0436
...
ax1.annotate('J0436-4114 (M9 $\gamma$) $T_\mathrm{eff}: 2565 \pm 257$ K', xy=(1.121, 3.2), color='#9B0132', fontsize=15)
# Trappist
...
ax1.annotate('vB 8 (M7) $T_\mathrm{eff}: 2642 \pm 34$ K', xy=(1.121, 6.2), color='#04A57F', fontsize=15)
