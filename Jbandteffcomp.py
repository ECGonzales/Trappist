...
ax1.annotate('J0608-2753 (L0 $\gamma$) $T_\mathrm{eff}: 2520 \pm 250$ K', xy=(1.121, 1.2), color='#FF6B03', fontsize=15)
# vb10
...
ax1.annotate('vB 10 (M8) $T_\mathrm{eff}: 2524 \pm 45$ K', xy=(1.121, 2.2), color='#275202', fontsize=15)
# 0436
...
ax1.annotate('J0320+1854 (M8) $T_\mathrm{eff}: 2612 \pm 34$ K', xy=(1.121, 4.2), color='#1EE801', fontsize=15)
# Trappist
ax1.plot(trap_bin[0], trap_bin[1] + 4, c='k')
# ax1.plot(df_trap['w'], norm_df_trap + 3, c='k')
ax1.annotate('TRAPPIST-1 (M7.5) $T_\mathrm{eff}: 2626 \pm 34$ K', xy=(1.121, 5.2), color='k', fontsize=15)
# vb8
...
ax1.annotate('vB 8 (M7) $T_\mathrm{eff}: 2652 \pm 34$ K', xy=(1.121, 6.2), color='#04A57F', fontsize=15)
