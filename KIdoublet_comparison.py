...
ax1.annotate('Trappist-1 T$_\mathrm{eff}: 2581 \pm 34$ K', xy=(1.220, 3.2), color='k', fontsize=12)
...
# ------- Label Sources -------------
ax1.annotate('Trappist-1 T$_\mathrm{eff}: 2581 \pm 34$ K', xy=(1.144, 1.2), color='k', fontsize=12)
