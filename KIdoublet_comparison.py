...
ax1.annotate('J1256-0224 T$_\mathrm{eff}: 2400 \pm 320$ K', xy=(1.220, 2.2), color='blue', fontsize=12)
ax1.annotate('Trappist-1 T$_\mathrm{eff}: 2563 \pm 47$ K', xy=(1.220, 3.2), color='k', fontsize=12)
ax1.annotate('LHS 377 T$_\mathrm{eff}: 2784 \pm 42$ K', xy=(1.220, 4.2), color='#01A1D6', fontsize=12)
...
# ------- Label Sources -------------
ax1.annotate('Trappist-1 T$_\mathrm{eff}: 2563 \pm 47$ K', xy=(1.144, 1.2), color='k', fontsize=12)
ax1.annotate('LHS 377 T$_\mathrm{eff}: 2784 \pm 42$ K', xy=(1.144, 2.2), color='#01A1D6', fontsize=12)
