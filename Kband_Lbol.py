...
ax1.annotate('J1207-3900 (L1 VL-G) $L_\mathrm{bol}: -3.336 \pm 0.053$', xy=(2.001, 1.2), color='#1036CF', fontsize=13)
# 0518
...
ax1.annotate('J0518-2756 (L1 VL-G) $L_\mathrm{bol}: -3.328 \pm 0.041$', xy=(2.001, 2.2), color='#5518C2', fontsize=13)
# vb10
...
ax1.annotate('vb10 (M8) $L_\mathrm{bol}: -3.298 \pm 0.002$', xy=(2.001, 3.2), color='#275202', fontsize=13)
# Trappist
...
ax1.annotate('J0443+0002 (L0 VL-G) $L_\mathrm{bol}: -3.194\pm 0.003$', xy=(2.001, 6.2), color='#E71BF8', fontsize=13)
# vb8
...
ax1.annotate('vb8 (M7) $L_\mathrm{bol}: -3.192 \pm 0.002$', xy=(2.001, 7.2), color='#04A57F', fontsize=13)
