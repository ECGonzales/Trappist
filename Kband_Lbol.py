...
ax1.annotate('J1207-3900 (L1 $\gamma$) $L_\mathrm{bol}: -3.336 \pm 0.053$', xy=(2.001, 1.2), color='#1036CF', fontsize=14)
# 0518
ax1.plot(trap_bin[0], trap_bin[1] + 1, c='k')
ax1.plot(J0518_bin[0], J0518_bin[1] + 1, c='#5518C2', alpha=0.75)
# ax1.plot(df_trap['w'], norm_df_trap + 1, c='k')
# ax1.plot(df_0518['w'], norm_df_0518 + 1, c='#5518C2', alpha=0.75)
ax1.annotate('J0518-2756 (L1 $\gamma$) $L_\mathrm{bol}: -3.328 \pm 0.041$', xy=(2.001, 2.2), color='#5518C2', fontsize=14)
# vb10
...
ax1.annotate('TRAPPIST-1 (M7.5) $L_\mathrm{bol}: -3.255 \pm 0.002$', xy=(2.001, 4.2), color='k', fontsize=14)
# 320
...
ax1.annotate('J0320+1854 (M8) $L_\mathrm{bol}: -3.225 \pm 0.002$', xy=(2.001, 5.2), color='#1EE801', fontsize=14)
# 0443
...
ax1.annotate('J0443+0002 (L0 $\gamma$) $L_\mathrm{bol}: -3.194\pm 0.003$', xy=(2.001, 6.2), color='#E71BF8', fontsize=14)
# vb8
