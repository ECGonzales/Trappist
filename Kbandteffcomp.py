...
ax1.annotate('J0608-2753 (L0 $\gamma$) $T_\mathrm{eff}: 2510 \pm 250$ K', xy=(2.001, 1.15), color='#FF6B03', fontsize=15)
# vb10
...
ax1.annotate('vB 10 (M8) $T_\mathrm{eff}: 2540 \pm 45$ K', xy=(2.001, 1.67), color='#275202', fontsize=15)
# 0436
...
ax1.annotate('J0436-4114 (M9 $\gamma$) $T_\mathrm{eff}: 2570 \pm 260$ K', xy=(2.001, 2.2), color='#9B0132', fontsize=15)
# 0320
ax1.plot(trap_bin[0], trap_bin[1] + 1.7, c='k')
# ax1.plot(df_trap['w'], norm_df_trap + 2.25, c='k')
ax1.plot(df_0320['w'], norm_df_0320 + 1.7, c='#1EE801', alpha=0.75)
ax1.annotate('J0320+1854 (M8) $T_\mathrm{eff}: 2614 \pm 34$ K', xy=(2.001, 2.8), color='#1EE801', fontsize=15)
# Trappist
ax1.plot(trap_bin[0], trap_bin[1] + 2.25, c='k')
# ax1.plot(df_trap['w'], norm_df_trap + 1.7, c='k')
ax1.annotate('TRAPPIST-1 (M7.5) $T_\mathrm{eff}: 2629 \pm 34$ K', xy=(2.001, 3.4), color='k', fontsize=15)
# vb8
...
ax1.annotate('vB 8 (M7) $T_\mathrm{eff}: 2643 \pm 34$ K', xy=(2.001, 3.95), color='#04A57F', fontsize=15)
