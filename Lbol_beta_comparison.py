...
df_trap = pd.read_csv('Data/Smooth_output_PS_new/BetaLboloverall/Gaia2306-0502 (M7.5) SED_spexified.txt', sep=" ",
...
#                             names=["w", "f", "err"])
df_0714 = pd.read_csv('Data/Smooth_output_PS_new/BetaLboloverall/PS_0714+3702 (M8) SED_spexified.txt', sep=" ", comment='#',
                      header=None, names=["w", "f", "err"])
...
# Trappist-1
ax1.annotate('TRAPPIST-1 (M7.5)     $L_\mathrm{bol}: -3.253 \pm 0.012$', xy=(1.95, 2*10**(-14)), color='k', fontsize=15)
# J2154
