...
beta = plt.scatter(df_beta['spt'], df_beta['Lbol'], color='#D01810', marker='s', s=70, zorder=5)
ax1.errorbar(df_beta['spt'], df_beta['Lbol'], yerr=df_beta['Lbol_err'], c='#D01810', fmt='s', zorder=6)
...
plt.scatter(df_trappist['SpT'], df_trappist['lbol'], color='k', s=700, zorder=9, marker="*")
ax1.annotate('Trappist-1', xy=(7, -3.8), color='k', fontsize=12)
