...
beta = plt.scatter(df_beta['spt'], df_beta['Teff'], color='#FF6B03', marker='o', s=70, zorder=5)
ax1.errorbar(df_beta['spt'], df_beta['Teff'], yerr=df_beta['Teff_err'], c='#FF6B03', fmt='o', zorder=6)
...
trap= plt.scatter(df_trappist['SpT'], df_trappist['Teff'], color='k', s=700, zorder=9, marker="*")
