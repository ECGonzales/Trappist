...
# ----- Add data -----
fld = plt.scatter(df_field['spt'], df_field['AbsW1'], color='#7C7D70', s=70)
ax1.errorbar(df_field['spt'], df_field['AbsW1'], yerr=df_field['AbsW1_err'], c='#7C7D70', fmt='o')
gamma = plt.scatter(df_gamma['SpT'], df_gamma['AbsW1'], color='#9B0132', s=70)
ax1.errorbar(df_gamma['SpT'], df_gamma['AbsW1'], yerr=df_gamma['AbsW1_err'], c='#9B0132', fmt='o')
beta = plt.scatter(df_beta['SpT'], df_beta['AbsW1'], color='#D01810', s=70, marker='s')
ax1.errorbar(df_beta['SpT'], df_beta['AbsW1'], yerr=df_beta['AbsW1_err'], c='#D01810', fmt='s')
sub = plt.scatter(df_sub['SpT'], df_sub['MW1'], color='blue', s=70, zorder=5)
ax1.errorbar(df_sub['SpT'], df_sub['MW1'], yerr=df_sub['MW1_unc'], c='blue', fmt='o', zorder=6)
trap = plt.scatter(df_trappist['SpT'], df_trappist['MW1'], color='k', s=700, zorder=7, marker="*")
ax1.errorbar(df_trappist['SpT'], df_trappist['MW1'], yerr=df_trappist['MW1_unc'], c='k', fmt='*', zorder=6)
...
plt.tight_layout()
plt.savefig('Figures/Spt_vs_W1.pdf', dpi=150)