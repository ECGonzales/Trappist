...
opt = df[(df['w'] <= 0.94105)]
overlap = df[(df['w'] >= 0.941040) & (df['w'] <= 1.037)]
nir = df[(df['w'] >= 1.03)]
...
ax1.scatter(df2['w'][0], df2['f'][0],  c='#ae017e', s=150)  # 2MASS_H
ax1.scatter(df2['w'][1], df2['f'][1],  c='#ae017e', s=150)  # 2MASS_J
ax1.scatter(df2['w'][2], df2['f'][2],  c='#ae017e', s=150)  # 2MASS_K
ax1.scatter(df2['w'][3], df2['f'][3],  c='#dd3497', s=150)  # Cousins_I
ax1.scatter(df2['w'][4], df2['f'][4],  c='#dd3497', s=150)  # Cousins_R
ax1.scatter(df2['w'][5], df2['f'][5],  c='#f768a1', s=150)  # Johnson_V
ax1.scatter(df2['w'][6], df2['f'][6],  c='#7a0177', s=150)  # WISE_W1
ax1.scatter(df2['w'][7], df2['f'][7],  c='#7a0177', s=150)  # WISE_W2
ax1.scatter(df2['w'][8], df2['f'][8],  c='#7a0177', s=150)  # WISE_W3
...
ax1.annotate('R-C Spec', xy=(0.75, 0.2*10**(-15)), color='#0179FF', fontsize=15)
