...
#  ---------- add data -------------
# gamma group
gamma_in = plt.scatter(df_gamma_group['V'], df_gamma_group['U'], color='white', edgecolors='#9B0132', s=70)
ax1.errorbar(df_gamma_group['V'], df_gamma_group['U'], xerr=df_gamma_group['dV'],yerr=df_gamma_group['dU'], c='#9B0132',
             fmt='o', mfc='white')
# gamma non
gamma_out = plt.scatter(df_gamma_nogroup['V'], df_gamma_nogroup['U'], color='#9B0132', s=70,marker="o")
ax1.errorbar(df_gamma_nogroup['V'], df_gamma_nogroup['U'], xerr=df_gamma_nogroup['dV'], yerr=df_gamma_nogroup['dU'],
             c='#9B0132', fmt='o')
# beta non
beta_out = plt.scatter(df_beta_nogroup['V'], df_beta_nogroup['U'], color='#FF6B03', s=70)
ax1.errorbar(df_beta_nogroup['V'], df_beta_nogroup['U'], xerr=df_beta_nogroup['dV'],yerr=df_beta_nogroup['dU'],
             c='#FF6B03', fmt='o')
# TRAPPIST-1
trappist = plt.scatter(trap_V, trap_U, color='k', s=700, marker='*')
ax1.errorbar(trap_V, trap_U, xerr=trap_dV,yerr=trap_dU, c='k', fmt='o')
...
#  ---------- add data -------------
# gamma group
gamma_in = plt.scatter(df_gamma_group['W'], df_gamma_group['U'], color='white', edgecolors='#9B0132', s=70)
ax1.errorbar(df_gamma_group['W'], df_gamma_group['U'], xerr=df_gamma_group['dW'],yerr=df_gamma_group['dU'], c='#9B0132',
             fmt='o', mfc='white')
# gamma non
gamma_out = plt.scatter(df_gamma_nogroup['W'], df_gamma_nogroup['U'], color='#9B0132', s=70,
                        marker="o")
ax1.errorbar(df_gamma_nogroup['W'], df_gamma_nogroup['U'], xerr=df_gamma_nogroup['dW'], yerr=df_gamma_nogroup['dU'],
             c='#9B0132', fmt='o')
# beta non
beta_out = plt.scatter(df_beta_nogroup['W'], df_beta_nogroup['U'], color='#FF6B03', s=70)
ax1.errorbar(df_beta_nogroup['W'], df_beta_nogroup['U'], xerr=df_beta_nogroup['dW'],yerr=df_beta_nogroup['dU'],
             c='#FF6B03', fmt='o')
# TRAPPIST-1
trappist = plt.scatter(trap_W, trap_U, color='k', s=700, marker='*')
ax1.errorbar(trap_W, trap_U, xerr=trap_dW,yerr=trap_dU, c='k', fmt='o')
...
#  ---------- add data -------------
# gamma group
gamma_in = plt.scatter(df_gamma_group['W'], df_gamma_group['V'], color='white', edgecolors='#9B0132', s=70)
ax1.errorbar(df_gamma_group['W'], df_gamma_group['V'], xerr=df_gamma_group['dW'],yerr=df_gamma_group['dV'], c='#9B0132',
             fmt='o', mfc='white')
# gamma non
gamma_out = plt.scatter(df_gamma_nogroup['W'], df_gamma_nogroup['V'], color='#9B0132', s=70,marker="o")
ax1.errorbar(df_gamma_nogroup['W'], df_gamma_nogroup['V'], xerr=df_gamma_nogroup['dW'], yerr=df_gamma_nogroup['dV'],
             c='#9B0132', fmt='o')
# beta non
beta_out = plt.scatter(df_beta_nogroup['W'], df_beta_nogroup['V'], color='#FF6B03', s=70)
ax1.errorbar(df_beta_nogroup['W'], df_beta_nogroup['V'], xerr=df_beta_nogroup['dW'],yerr=df_beta_nogroup['dV'],
             c='#FF6B03', fmt='o')
# TRAPPIST-1
trappist = plt.scatter(trap_W, trap_V, color='k', s=700, marker='*')
