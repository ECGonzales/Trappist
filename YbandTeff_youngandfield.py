...
ax1.annotate('FeH', xy=(0.998, 4.76), color='k', fontsize=15)
FeH2d = pd.DataFrame()
FeH2d['x'] = [0.998, 0.998]
FeH2d['y'] = [4.6, 4.75]
...
ax1.annotate('VO', xy=(1.0456, 4.55), color='k', fontsize=15)
VOd = pd.DataFrame()
VOd['x'] = [1.0456, 1.0456]
VOd['y'] = [4.54, 4.41]
...
ax1.annotate('H$_\mathrm{2} $O', xy=(1.08, 5.05), color='k', fontsize=15)
H2Od = pd.DataFrame()
H2Od['x'] = [1.08, 1.08]
H2Od['y'] = [4.85, 5]
