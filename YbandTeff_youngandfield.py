...
ax1.annotate('J0608-2753 (L0 $\gamma$) $T_\mathrm{eff}: 2471 \pm 255$ K', xy=(0.951, 1.5), color='#FF6B03', fontsize=15)
# vb10
...
ax1.annotate('J0436-4114 (M9 $\gamma$) $T_\mathrm{eff}: 2565 \pm 257$ K', xy=(0.951, 3.5), color='#9B0132', fontsize=15)
# Trappist
