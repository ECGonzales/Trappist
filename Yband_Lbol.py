...
ax1.annotate('J1207-3900 (L1 $\gamma$) $L_\mathrm{bol}: -3.337 \pm 0.053$', xy=(0.951, 1.57), color='#1036CF', fontsize=14)
# vb10
...
ax1.annotate('J0320+1854 (M8) $L_\mathrm{bol}: -3.226 \pm 0.007$', xy=(0.951, 4.75), color='#1EE801', fontsize=14)
# Trappist
ax1.plot(trap_bin[0], trap_bin[1] + 4.5, c='k')
# ax1.plot(df_trap['w'], norm_df_trap + 3.5, c='k')
ax1.annotate('TRAPPIST-1 (M7.5) $L_\mathrm{bol}: -3.210 \pm 0.012$', xy=(0.951, 5.7), color='k', fontsize=14)
# 0443
...
ax1.annotate('vB 8 (M7) $L_\mathrm{bol}: -3.193 \pm 0.006$', xy=(0.951, 7.7), color='#04A57F', fontsize=14)
