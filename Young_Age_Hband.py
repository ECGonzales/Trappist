...
ax1.annotate('J1048-3956 (M9) $T_\mathrm{eff}: 2333 \pm 54$ K', xy=(1.421, 2.3), color='#275202', fontsize=15)
# 0853
ax1.plot(trap_bin[0], trap_bin[1] + 2, c='k')
ax1.plot(df_0853, norm_df_0853 + 2, c='#09BD8C', alpha=0.75)
ax1.annotate('J0853-0356 (M9) $T_\mathrm{eff}: 2334 \pm 54$ K', xy=(1.421, 3.2), color='#09BD8C', fontsize=15)
# 2000
ax1.plot(trap_bin[0], trap_bin[1] + 3, c='k')
ax1.plot(J2000_bin[0], J2000_bin[1] + 3, c='#A85C05', alpha=0.75)
ax1.annotate('J2000-7523 (M9 $\gamma$) $T_\mathrm{eff}: 2388 \pm 36$ K', xy=(1.421, 4.3), color='#A85C05', fontsize=15)
# 0608
