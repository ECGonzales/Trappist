...
df_trap = pd.read_csv('Data/Smooth_output_PS_new/youth_field/PS_Gaia_youth_2306-0502 (M7.5) SED_spexified.txt', sep=" ",
...
df_1048 = pd.read_csv('Data/Smooth_output_PS_new/youth_field/Gaia1048-3956 (M9) SED_spexified.txt', sep=" ",
                      comment='#', header=None, names=["w", "f", "err"])
df_1048_phot = pd.read_csv('Data/Young_Age_Comp/youth_field/Gaia1048-3956 (M9) phot.txt', sep=" ",comment='#', header=None,
                           names=["w", "f", "err"])

df_1835 = pd.read_csv('Data/Smooth_output_PS_new/youth_field/PS_new_1835+3259 (M8.5) SED_spexified.txt', sep=" ",
                      comment='#', header=None, names=["w", "f", "err"])
df_1835_phot = pd.read_csv('Data/Young_Age_Comp/youth_field/PS_new_1835+3259 (M8.5) phot.txt', sep=" ",comment='#', header=None,
                           names=["w", "f", "err"])

df_0853 = pd.read_csv('Data/Smooth_output_PS_new/youth_field/PS_new_0853-0329 (M9) SED_spexified.txt', sep=" ",
                      comment='#', header=None, names=["w", "f", "err"])
df_0853_phot = pd.read_csv('Data/Young_Age_Comp/youth_field/PS_new_0853-0329 (M9) phot.txt', sep=" ",comment='#', header=None,
                           names=["w", "f", "err"])
...
ax1.loglog(df_1048['w'], df_1048['f'], c='#1CA844')
ax1.scatter(df_1048_phot['w'], df_1048_phot['f'], c='k', s=70)
ax1.scatter(df_1048_phot['w'], df_1048_phot['f'], c='#1CA844', s=50)
ax1.loglog(df_0853['w'], df_0853['f'], c='#09BD8C')
ax1.scatter(df_0853_phot['w'], df_0853_phot['f'], c='k', s=70)
ax1.scatter(df_0853_phot['w'], df_0853_phot['f'], c='#09BD8C', s=50)
