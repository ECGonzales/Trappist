...
df_trap = pd.read_csv('Data/Smooth_output_PS/youth_old/PS_2306-0502 (M7.5) SED_spexified.txt', sep=" ",
...
df_1256 = pd.read_csv('Data/Smooth_output_PS/youth_old/PS_1256-0224 (L3.5sd) SED_spexified.txt', sep=" ",
                      comment='#', header=None, names=["w", "f", "err"])
df_1256_phot = pd.read_csv('Data/Subdwarfs_PSversions/PS_1256-0224 (L3.5sd) phot.txt', sep=" ",comment='#', header=None,
                           names=["w", "f", "err"])

df_1444 = pd.read_csv('Data/Smooth_output_PS/youth_old/PS_1444-2019 (M9sd) SED_spexified.txt', sep=" ",
                      comment='#', header=None, names=["w", "f", "err"])
df_1444_phot = pd.read_csv('Data/Subdwarfs_PSversions/PS_1444-2019 (M9sd) phot.txt', sep=" ", comment='#', header=None,
                           names=["w", "f", "err"])

df_GJ660 = pd.read_csv('Data/Smooth_output_PS/youth_old/PSspectra_gj6601b_est_spexified.txt', sep=" ", comment='#',
...
ax1.annotate('GJ 660.1B (d/sdM7)   $T_\mathrm{eff}: 2421 \pm 91$ K', xy=(2.5, 6*10**(-15)), color='#07D1E8', fontsize=15)
ax1.annotate('J1444-2019 (sdM9)   $T_\mathrm{eff}: 2479 \pm 13$ K', xy=(2.5, 4*10**(-15)), color='mediumblue', fontsize=15)
