...
df_trap = pd.read_csv('Data/Smooth_output_PS/youth_lowgteff/PS_2306-0502 (M7.5) SED_spexified.txt', sep=" ",
...
df_2000 = pd.read_csv('Data/Smooth_output_PS/youth_lowgteff/Gaia2000-7523 (M9gamma) SED_spexified.txt', sep=" ",
                      comment='#', header=None, names=["w", "f", "err"])
df_2000_phot = pd.read_csv('../Atmospheres_paper/Data/Gaia2000-7523 (M9gamma) phot.txt', sep=" ",comment='#', header=None,
                           names=["w", "f", "err"])

df_0608 = pd.read_csv('Data/Smooth_output_PS/youth_lowgteff/PS_0608-2753 (M8.5gamma) SED_spexified.txt', sep=" ",
                      comment='#', header=None, names=["w", "f", "err"])
...
ax1.annotate('TRAPPIST-1 (M7.5) $T_\mathrm{eff}: 2319 \pm 232$ K', xy=(2.5, 1.7*10**(-14)), color='k', fontsize=15)
ax1.annotate('J0608-2753 (L0 $\gamma$)  $T_\mathrm{eff}: 2520 \pm 250 $ K', xy=(2.5, 1.2*10**(-14)), color='#D41304',fontsize=15)
ax1.annotate('J200-7523 (M9 $\gamma$)   $T_\mathrm{eff}: 2388 \pm 36$ K', xy=(2.5, 8.3*10**(-15)), color='#A85C05', fontsize=15)
